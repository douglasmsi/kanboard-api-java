...
public abstract class RestServiceDefault implements RestService {
    ...
    public <RESPONSE_TYPE> KanboardResponse<RESPONSE_TYPE> sendRequest(String jsonRequest) {
        ...
        //headers.add("X-API-Auth", encodeApiToken());
    	headers.add("Authorization", "Basic " + encodeApiToken());
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> entity = new HttpEntity<String>(jsonRequest, headers);
        String answer = restTemplate.postForObject(this.kanboardApi.getApiUrl(), entity, String.class);
        ...
        try {
            ...
            httpConnection.setRequestProperty("Authorization", "Basic " + encodeApiToken());
